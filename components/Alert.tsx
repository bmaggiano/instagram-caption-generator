...
export default function AlertDemo() {
  return (
    <Alert>
      ...
      <AlertDescription>
      Please note that all photos uploaded on this app are saved locally in your browser and at <a className="text-blue-500" href="https://uploadthing.com/" target="_blank">UploadThing</a>. 
